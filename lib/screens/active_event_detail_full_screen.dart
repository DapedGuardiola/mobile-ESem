...
class ActiveEventDetailFullScreen extends StatefulWidget {
  final int? eventId;
  final bool showExport;

  const ActiveEventDetailFullScreen({
    super.key,
    this.eventId,
  ...
  @override
  State<ActiveEventDetailFullScreen> createState() => _ActiveEventDetailFullScreenState();
}

class _ActiveEventDetailFullScreenState extends State<ActiveEventDetailFullScreen> {
